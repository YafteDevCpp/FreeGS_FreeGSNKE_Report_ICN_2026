...
\articletype{Reporte de Investigación}
...
\jnlsetup{%
    ...
    journal = {Reporte de Investigación},
    title   = {Reporte de Progreso Usando FreeGS y FreeGSNKE (Titulo temporal)},  % Manuscript title
    ctitle  = {Lol},  % Manuscript title
    volume  = {1},
    number  = {1},
    year    = {2026},
